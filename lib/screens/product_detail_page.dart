  ...
  Future<void> _togglePriceAlert() async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('請先登入，才能使用降價通知。')));
      return;
    }
    ...
    if (_alertEnabled) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('已取消降價通知。')));
      return;
    }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '價格：\$${widget.product.price.toStringAsFixed(0)}',
                          ),
                          Text(
                            '主成分：${widget.product.mainIngredients.join(', ')}',
                          ),
                          ...
                          if (widget.product.userScore != null &&
                          ...
                          if (_loadingAlert)
                            ...
                            OutlinedButton.icon(
                              ...
                              label: Text(
                                _alertEnabled ? '已設定降價通知（點擊可取消）' : '設定降價通知',
                              ),
                            ),
                        ],
                      ),
