...
class _HomePageState extends ConsumerState<HomePage> with RouteAware {
  ...
  final List<Product> _staticProducts = const [
    ...
    Product(id: 'static-5', name: '日間清爽防曬', price: 690, mainIngredients: ['氧化鋅', '維他命E'], rating: 3, affiliateUrl: 'https://example.com/day-sunscreen', isFeatured: true, clickCount: 0, imageUrl: 'https://images.unsplash.com/photo-1619451687485-878a53e28d32?auto=format&fit=crop&w=900&q=80'),
