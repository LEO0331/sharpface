...
export default function Home() {
  ...
  return <>
    ...
    <section className="section"><h2>How to use this collection</h2><p className="lead">Read a question first. Reveal key concepts when you need a nudge, then the answer approach. Open the full answer only after you have tried your own response.</p><div className="actions"><Link className="button secondary" href="/about">About the sources</Link><a className="text-link" href="https://leo0331.github.io/sharpface/" target="_blank" rel="noopener noreferrer">GitHub →</a></div></section></div>
  </>;
}
